    ...
    <div className='flex items-start justify-center max-w-6xl mx-auto p-8 mt-24'>
      {cart.length>0?(
        <div className='flex flex-col lg:flex-row w-full'>
          ...
          <div className='p-6 lg:ml-8 mt-8 lg:mt-0 flex flex-col justify-between h-[80vh] w-full lg:w-1/3 lg:sticky lg:top-20'>
...
<div className='text-lg text-gray-700 font-semibold'>
  <p className='mb-1'>Total Amount:<strong className='text-black'>${totalAmount.toFixed(2)}
    </strong>
    </p>
</div>
<button className='mt-4 bg-green-600 text-white py-2 px-4 w-full rounded hover:bg-gray-700 transition duration-300'>
CheckoutNow
</button>
</div>
</div>
